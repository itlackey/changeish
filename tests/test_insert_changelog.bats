...
# # EOF
# #     export debug="1"
# #     run_update_changelog CHANGELOG.md "- new content" "v1.0.0" update "## v1.0.0\n- old content"
# #     [ "$status" -eq 0 ] || {
...
# # - old auto
# # EOF
# #     run_update_changelog CHANGELOG.md "- auto new" "v2.0.0" auto "## v2.0.0\n- old auto"
# #     cat CHANGELOG.md >>"$ERROR_LOG"
# #     assert_success
...
# @test "ensure_blank_lines: adds blank lines around headers" {
#     cat >input.txt <<EOF
# # Header1
# Content1
# ## Header2
...
#     output=$(cat input.txt | ensure_blank_lines)

#     expected_output=$'# Header1\n\nContent1\n\n## Header2\n\nContent2'

#     [ "$output" = "$expected_output" ] || {
#         echo -e "Expected output:\n$expected_output" >> "$ERROR_LOG"
#         echo -e "Actual output:\n$output" >> "$ERROR_LOG"
#         false
#     }
# }

# @test "ensure_blank_lines: removes multiple blank lines" {
#     cat >input.txt <<EOF
# # Header1
...
# @test "ensure_blank_lines: handles empty input" {
#     echo "" >input.txt
